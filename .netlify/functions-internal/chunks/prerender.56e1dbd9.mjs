	...
	${maybeRenderHead()}<section class="bg0 p-t-80 p-b-50 astro-TVB3CCAD">
		<div class="container astro-TVB3CCAD">
					...
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm astro-TVB3CCAD">						
						...
						<div class="filter-col2 p-r-15 p-b-27 astro-TVB3CCAD">
							...
							<ul class="astro-TVB3CCAD">
								...
								${tableauAge.map((ages) => renderTemplate`<li class="p-b-6 astro-TVB3CCAD">
										<div class="form-check astro-TVB3CCAD">
											<input class="form-check-input astro-TVB3CCAD" type="radio" name="age" id="exampleRadios1"${addAttribute(ages, "value")} checked>
											<label class="form-check-label astro-TVB3CCAD" for="exampleRadios1">
												${ages}
											</label>
									</div>
			...
			<div class="row isotope-grid astro-TVB3CCAD">
                ${profils.map((profil) => renderTemplate`<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women astro-TVB3CCAD">
                        <div class="block2 astro-TVB3CCAD">
                            <div class="block2-pic hov-img0 block-img  astro-TVB3CCAD">
                                <img${addAttribute(profil.photoDeProfil, "src")} alt="IMG-PRODUCT" class="astro-TVB3CCAD">

                                <a${addAttribute("chat?id=" + profil.id, "href")} class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 astro-TVB3CCAD">
                                    Chat
                                </a>
                            </div>

                            <div class="block2-txt flex-w flex-t p-t-14 astro-TVB3CCAD">
                                <div class="block2-txt-child1 flex-col-l  astro-TVB3CCAD">
                                    <a${addAttribute("/profile?id=" + profil.id, "href")} class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 astro-TVB3CCAD">
                                        ${profil.pseudo} 
                                    </a>
                                </div>
                            </div>
